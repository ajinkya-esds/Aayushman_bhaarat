...
import 'package:aayushman_bhaarat/utils/introduction_widget/ui/intro_button.dart';
import 'package:aayushman_bhaarat/utils/introduction_widget/ui/intro_page.dart';
import 'package:collection/collection.dart';
import 'package:flutter/material.dart';
import 'package:flutter_keyboard_visibility/flutter_keyboard_visibility.dart';

import '../dot_indicator/dots_decorator.dart';
import '../dot_indicator/dots_indicator.dart' show DotsDecorator, DotsIndicator;
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.showSkipButton) {
      leftBtn = Visibility(
        ...
        maintainSize: true,
        child: widget.overrideSkip ?? IntroButton(style: widget.baseBtnStyle?.merge(widget.skipStyle) ?? widget.skipStyle, semanticLabel: widget.skipSemantic, onPressed: _onSkip, child: widget.skip!),
      );
        ...
        body: Container(
          ...
          child: Stack(
            children: [
                    ...
                    children: widget.pages
                            ?.mapIndexed(
                              (index, page) => Padding(
                                ...
                                child: IntroPage(page: page, scrollController: CustomList(widget.scrollControllers)?.elementAtOrNull(index)),
                              ),
                            )
                            .toList() ??
                        widget.rawPages!,
              ...
              if (widget.globalHeader != null) Positioned(top: 0, left: 0, right: 0, child: widget.globalHeader!),
              if (_showBottom)
                Positioned(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Row(
                            children: [
                          Expanded(flex: widget.skipOrBackFlex, child: leftBtn ?? const SizedBox()),
                          Expanded(
                            ...
                            child: Center(
                              child: widget.isProgress
                                  ? widget.customProgress ??
                                      Semantics(
                                        label: "Page ${getCurrentPage() + 1} of ${getPagesLength()}",
                          ...
                          Expanded(flex: widget.nextFlex, child: rightBtn ?? const SizedBox()),
