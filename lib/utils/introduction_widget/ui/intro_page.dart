...
class _IntroPageState extends State<IntroPage> with AutomaticKeepAliveClientMixin {
            ...
            children: [
              ...[
                ...
                Expanded(
                  ...
                  child: page.useScrollView ? SingleChildScrollView(controller: widget.scrollController, physics: const BouncingScrollPhysics(), child: content) : content,
                ),
              ].asReversed(page.reverse),
              if (page.footer != null) Flexible(flex: page.decoration.footerFlex, fit: page.decoration.footerFit, child: page.footer!),
              SafeArea(
                top: false,
  ...
  Widget _buildFlex(context) {
    ...
    return Container(
      ...
      child: Flex(
        direction: page.useRowInLandscape && orientation == Orientation.landscape ? Axis.horizontal : Axis.vertical,
